...
const ProductDetail = () => {
  ...
  const { id } = useParams();
  //! dinamik routelardaki parametreyi yakalar. route ayarlaması yaparken ne isim verdiysek useParams ile onu yakalarız.
  // console.log(params);
  // const { state } = useLocation();
  //!  navigate ile taşınan veriyi useLocation() hooku ile karşılayabiliyoruz. urlde yer alan parametreleri search ile yakalayabiliyoruz.
  // console.log(state);
